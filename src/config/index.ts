export class Config {
  ...
  constructor() {
    ...
    // Identity-service + auth del panel de docs (por defecto el nombre de contenedor,
    this.identityServiceUrl = process.env.IDENTITY_SERVICE_URL || 'http://identity-service:3001';
